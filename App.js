  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img className="logo" src="https://img.freepik.com/free-vector/delivery-logo-template_23-2147880262.jpg?size=626&ext=jpg&ga=GA1.1.1748414857.1702384156&semt=ais"/>
      </div>
...
const resList = [
  ...
  },
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2023-12-12 23:57:00",
        "opened": true
      },
      "badges": {
        "imageBadges": [
  ...
  },
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2023-12-12 21:45:00",
        "opened": true
      },
      "badges": {
        "imageBadges": [
    ...
    "cta": {
      "link": "https://www.swiggy.com/restaurants/mithas-g-block-kidwai-nagar-kanpur-216056",
      "type": "WEBLINK"
    }
  },
  {
  ...
  },
  {
    "info": {
      "id": "74507",
      "name": "Domino's Pizza",
      "cloudinaryImageId": "lek4x4cynp8yezxtm2up",
      "locality": "South X Mall",
      ...
      "availability": {
        "nextCloseTime": "2023-12-13 00:55:00",
        "opened": true
      },
      "badges": {
    ...
    "cta": {
      "link": "https://www.swiggy.com/restaurants/dominos-pizza-south-x-mall-kidwai-nagar-market-kanpur-74507",
      "type": "WEBLINK"
    }
  },
  {
    "info": {
      ...
      "cloudinaryImageId": "ttmomwt4amkbirnmhuo2",
    ...
    "cta": {
      "link": "https://www.swiggy.com/restaurants/kwality-walls-frozen-dessert-and-ice-cream-shop-niralanagar-saket-nagar-kanpur-287124",
      "type": "WEBLINK"
    }
  },
  {
...
const ResCard = (prop) =>{
  ...
  return (
    <div className="card"> 
      <img className="image"alt="Restaurant - logo" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+ cloudinaryImageId}/>
      <h4>{name}</h4>
      <h4>{cuisines.join(",")}</h4>
      <h4>{costForTwo}</h4>
      <h4>{avgRating}</h4>
